...
#define HELLO_WORLD_WR _IOWR('H', 1, char)
#define HELLO_WORLD_R  _IOR('H', 3, struct helloWorldMsg_Read_Write)

#define HELLO_WORLD_INIT  _IOW('H', 5, struct helloWorldProcInfo)
